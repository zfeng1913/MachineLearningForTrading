...
class DTLearner(object):
    ...
    def build_tree(self, data_x, data_y):
        ...
        i = self.selet_the_best_feature(data_x, data_y)
    ...
    def selet_the_best_feature(self, data_x, data_y):
        corr_array = [abs(np.corrcoef(data_x[:, k], data_y)[0,1]) for k in range(len(data_x[0]))]
        return np.argmax(corr_array)
